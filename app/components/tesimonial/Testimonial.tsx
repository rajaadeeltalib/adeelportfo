...
import testimonialOne from "/public/assets/images/testimonialOne.png";
import testimonialTwo from "/public/assets/images/testimonialTwo.png";
import testimonialThree from "/public/assets/images/testimonialThree.png";
...
function SampleNextArrow(props: Props) {
  ...
  return (
    <div
      className="w-14 h-12 bg-[#0c1821]  hover:bg-black duration-300 rounded-md text-2xl text-gray-400 flex flex-row justify-center items-center absolute top-0 right-0 shadow-shadowOne cursor-pointer z-10"
      onClick={onClick}
    >
      <HiArrowRight />
    </div>
